import { Box, Fade, Flex, Td, Text, Link } from "@chakra-ui/react";
...
export const Market = ({
  ...
  const assetDisplayName = replace.includes(marketName)
    ? marketName.substring(1)
    : marketName;

  const leverageString = leverage
    ? `${formatNumber(leverage, { minimumFractionDigits: 2 })}x`
    : "";
