...
export const V3BaseLargestWinsPositionTable = () => {
  const currentTimestamp = Math.floor(Date.now() / 1000); // Current Unix timestamp in seconds
  const timestampOneDayAgo = currentTimestamp - 259200; // Subtract 86400 seconds (24 hours), 172800 (2 days), 259200 (3 days)
