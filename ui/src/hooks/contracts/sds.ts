export const sdsPoolAddressMainnet = '0xc7BB32a4951600FBac701589C73e219b26Ca2DFC';
export const sdsAbi = [
  {
    inputs: [
      ...
      { internalType: 'contract LinkTokenInterface', name: '_link', type: 'address' },
  ...
  },
  {
    inputs: [],
    name: 'getLinkToken',
    outputs: [{ internalType: 'contract LinkTokenInterface', name: 'linkToken', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'contract LinkTokenInterface', name: '_linkToken', type: 'address' },
